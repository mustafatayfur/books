...
// *context type yardımıyla contexti ilgili komponente atadık.
// *İlgili veriyi this.context ile ulaştık.
//*2 - ) Provider -----> Cosumer
// *Context içine class component oluşturuldu.Veri state içine konuldu
// *Contexte ait Provider ile State te bulunan veriyi aldık.
// *Parent child ilişki   {this.props.children}
// * Veriyi göndereceğimiz componente Context import ediyoruz.
